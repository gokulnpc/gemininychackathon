...
export function ScriptReview() {
  ...
  const handleRegenerate = async () => {
    ...
    try {
      ...
      if ((isPresetMode || isTextMode) && transcript) {
    ...
    >
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <div className="flex gap-3 flex-shrink-0 ml-6">
          ...
          <Button
            ...
            disabled={regenerating || generating}
            className="rounded-full px-5 py-2 h-10 bg-[#B08D9F] hover:bg-[#C9A9B8] text-white"
          >
            {generating ? (
              <Loader2 className="w-4 h-4 mr-2 animate-spin" />
            ) : (
      ...
      <div className="space-y-4">
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl border border-[#B08D9F]/40 p-5"
        >
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xs font-semibold uppercase tracking-wide text-[#B08D9F]">

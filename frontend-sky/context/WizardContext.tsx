...
function wizardReducer(state: WizardState, action: WizardAction): WizardState {
  switch (action.type) {
    ...
    case "SET_UPLOADED_PICTURE":
      return { ...state, uploadedPicture: action.payload };
    case "SET_PICTURE_ROLE":
      return { ...state, pictureRole: action.payload };
    case "SET_LANGUAGE":
...
export function WizardProvider({
  ...
  children: ReactNode;
  initialTab?: "speech" | "text" | "preset";
  initialStep?: number;
}) {
  const [state, dispatch] = useReducer(wizardReducer, {
    ...initialState,
    messageTab: initialTab,

...
const PUBLIC_IMAGES = [
  {
    id: "pub-1",
    label: "Mountain Lake",
    url: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=576&h=1024&fit=crop",
  },
  {
    id: "pub-2",
    label: "City Skyline",
    url: "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=576&h=1024&fit=crop",
  },
  {
    id: "pub-3",
    label: "Ocean Waves",
    url: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=576&h=1024&fit=crop",
  },
  {
    id: "pub-4",
    label: "Forest Path",
    url: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=576&h=1024&fit=crop",
  },
  {
    id: "pub-5",
    label: "Sunset Clouds",
    url: "https://images.unsplash.com/photo-1495616811223-4d98c6e9c869?w=576&h=1024&fit=crop",
  },
  {
    id: "pub-6",
    label: "Neon Lights",
    url: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=576&h=1024&fit=crop",
  },
  {
    id: "pub-7",
    label: "Desert Dunes",
    url: "https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?w=576&h=1024&fit=crop",
  },
  {
    id: "pub-8",
    label: "Abstract Gradient",
    url: "https://images.unsplash.com/photo-1557682250-33bd709cbe85?w=576&h=1024&fit=crop",
  },
];
...
export function MediaPanel({ onInsertImage }: MediaPanelProps) {
  ...
  const fetchAssets = useCallback(async () => {
    try {
      ...
      console.warn(
        "[MediaPanel] Failed to list assets; using empty state.",
        error,
      );
      setAssets([]);
      setUrls({});

      ...
      <div className="w-[320px] space-y-4">
        ...
        <div className="bg-white rounded-2xl border border-[#E8E0DC] p-5">
          <div className="flex items-center gap-2 mb-4">
            <Sparkles className="w-4 h-4 text-[#5a9ab5]" />
          ...
          <div className="space-y-2">
            {[
              ...
              <button
                key={index}
                className="w-full text-left p-3 rounded-xl border border-[#E8E0DC] text-sm text-[#1A1A1A] hover:border-[#5a9ab5]/30 hover:bg-[#5a9ab5]/5 transition-all duration-200"
              >
                {improvement}
              </button>
            ))}
        ...
        <div className="bg-white rounded-2xl border border-[#E8E0DC] p-5">
          ...
          <div className="space-y-4">
            <div>
              ...
              <select className="w-full p-3 rounded-xl border border-[#E8E0DC] bg-white text-sm text-[#1A1A1A] focus:outline-none focus:ring-2 focus:ring-[#5a9ab5]/20 focus:border-[#5a9ab5]">

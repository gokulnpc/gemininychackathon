...
export const sidebarItems = [
  ...
  { id: 3, label: "Upload your Picture (opt.)", icon: "Image" },
...
export const stepTitles: Record<number, { title: string; subtitle: string }> = {
  ...
  2: {
    title: "Choose the Plot",
    subtitle: "Review and approve the generated script for your video",
  },
  3: {
    title: "Upload Your Picture",
    subtitle: "Be the character in your own story!",
  },
  4: {
  ...
  6: { title: "Video Style", subtitle: "Choose the visual style for your video" },
  7: {
    title: "Caption Style",
    subtitle: "Choose the caption style for your video",
  },
  8: {
    title: "Video Effect",
    subtitle:
